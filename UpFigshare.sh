...
if [ -z "$FILE_PATH" ] || [ -z "ACCESS_TOKEN" ]; then
        ...
        echo -e "For example:\nUploadFSY.sh -i /sanpper/genome/genomev2.fasta -u https://api.figshare.com/v2/account/articles/22707367/files -t 75050303821b87ab7c72038ab9eaf02d853766bd8f7cc695f390d5b9cdeda1fd230c462a7cb7c7a67ef7c507f27f3fde647c41451574d54609ef477874c4z11\n\n"
        exit 1
